 ...
 */
public class CountCalendar extends RelativeLayout {
    ...
    public CountCalendar(Context context,AttributeSet attributeSet) {
        super(context, attributeSet);
        inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view =  inflater.inflate(R.layout.calendar_count, this);
    ...
    private class CourseAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ViewItem viewItem;
            if (view == null){
                LayoutInflater inflater = LayoutInflater.from(CountCalendar.this.getContext());
