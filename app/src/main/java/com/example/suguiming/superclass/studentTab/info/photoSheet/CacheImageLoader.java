...
public class CacheImageLoader {
    ...
    private static CacheImageLoader mInstance = new CacheImageLoader();
    ...
    public Bitmap loadCacheImage(final String path, final CacheImageCallBack mCallBack) {
        return this.loadCacheImage(path, null, mCallBack);
    }

    public Bitmap loadCacheImage(final String path, final Point mPoint, final CacheImageCallBack mCallBack) {
